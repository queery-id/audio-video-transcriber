...
def find_speech_regions(filename, frame_width=4096, min_region_size=0.5, max_region_size=3.5):
...
def main():
    ...
    if regions:
        try:
            widgets = ["mengambil suara dari film: ", Percentage(), ' ', Bar(), ' ', ETA()]
            ...
            widgets = ["merubah percakapan jadi text: ", Percentage(), ' ', Bar(), ' ', ETA()]
            pbar = ProgressBar(widgets=widgets, maxval=len(regions)).start()
